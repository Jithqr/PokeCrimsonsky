...
- **236 alternate forms** in `src/lib/pokemon-forms.ts` (IDs 10001–10638), expanded from 127. New additions: Unown B–Z + ! + ? (27 forms), Vivillon 19 wing patterns, Zygarde Complete, Castform Sunny/Rainy/Snowy, Cherrim Sunshine, Shellos/Gastrodon East Sea, Burmy Sandy/Trash, Basculin Blue-Striped, Deerling/Sawsbuck seasonal (3 each), Flabébé/Floette color variants (4 each), Furfrou 9 trims, Meowstic Female, Aegislash Blade, Pumpkaboo/Gourgeist size forms (3 each), Wishiwashi School, Minior Core 7 colors, Mimikyu Busted, Toxtricity Low Key, Indeedee Female, Enamorus Therian, Palafin Hero, Maushold Family-of-Three, Squawkabilly Blue/Yellow/White, Terapagos Stellar, Ogerpon Wellspring/Hearthflame/Cornerstone masks.
